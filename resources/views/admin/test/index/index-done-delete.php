            ...
            .then(function(data) {
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="actionMenu">
                                ...
                                <a class="dropdown-item delete-action" data-id="${item.id}" href="#">Xóa</a>
                ...
                deleteButtons.forEach(function(button) {
                    button.addEventListener('click', function(e) {
                        e.preventDefault();
                        const shortUrlId = button.getAttribute('data-id');
                        const confirmation = confirm('Bạn có chắc chắn muốn xóa liên kết này?');
                        if (confirmation) {
                            $.ajax({
